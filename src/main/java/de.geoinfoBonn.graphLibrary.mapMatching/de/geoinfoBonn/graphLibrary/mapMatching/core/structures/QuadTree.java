...
import de.geoinfoBonn.graphLibrary.mapMatching.core.geometry.Envelope;

public class QuadTree<V> implements Serializable {
	...
	private class QTNode implements Serializable {
	...
	private class CoordinateContainer implements Serializable {
		/**
		 * 
		 */
		private static final long serialVersionUID = 1L;
