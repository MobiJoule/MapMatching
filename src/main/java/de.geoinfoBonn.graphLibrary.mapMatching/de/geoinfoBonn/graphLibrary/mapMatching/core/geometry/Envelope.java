...
public class Envelope implements Serializable {
	...
	public Envelope(org.locationtech.jts.geom.Envelope globalEnvelope) {
		this.x1 = globalEnvelope.getMinX();
		this.x2 = globalEnvelope.getMaxX();
		this.y1 = globalEnvelope.getMinY();
		this.y2 = globalEnvelope.getMaxY();
	}
